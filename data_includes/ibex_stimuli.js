...
[["condition_a", 5], "DashedAcceptabilityJudgment", {s: "Kızların halası sabaha olana kadar ağladılar."  } ],
[["condition_b", 5], "DashedAcceptabilityJudgment", {s: "Kızların halası sabaha olana kadar ağladı."  } ],
[["condition_c", 5], "DashedAcceptabilityJudgment", {s: "Kızın halası sabaha olana kadar ağladılar."  } ],
[["condition_d", 5], "DashedAcceptabilityJudgment", {s: "Kızın halası sabaha olana kadar ağladı."  } ],
...
[["condition_a", 7], "DashedAcceptabilityJudgment", {s: "Doktorların çiçekçisi günden güne durmadan zayıfladılar."  } ],
[["condition_b", 7], "DashedAcceptabilityJudgment", {s: "Doktorların çiçekçisi günden güne durmadan zayıfladı."  } ],
[["condition_c", 7], "DashedAcceptabilityJudgment", {s: "Doktorun çiçekçisi günden güne durmadan zayıfladılar."  } ],
[["condition_d", 7], "DashedAcceptabilityJudgment", {s: "Doktorun çiçekçisi günden güne durmadan zayıfladı."  } ],
[["condition_a", 8], "DashedAcceptabilityJudgment", {s: "Stajyerlerin eniştesi gece ikiden önce uyudular."  } ],
[["condition_b", 8], "DashedAcceptabilityJudgment", {s: "Stajyerlerin eniştesi gece ikiden önce uyudu."  } ],
[["condition_c", 8], "DashedAcceptabilityJudgment", {s: "Stajyerin eniştesi gece ikiden önce uyudular."  } ],
[["condition_d", 8], "DashedAcceptabilityJudgment", {s: "Stajyerin eniştesi gece ikiden önce uyudu."  } ],
...
[["condition_a", 10], "DashedAcceptabilityJudgment", {s: "Konuşmacıların sunucusu olağanüstü bir hızla koştular."  } ],
[["condition_b", 10], "DashedAcceptabilityJudgment", {s: "Konuşmacıların sunucusu olağanüstü bir hızla koştu."  } ],
[["condition_c", 10], "DashedAcceptabilityJudgment", {s: "Konuşmacının sunucusu olağanüstü bir hızla koştular."  } ],
[["condition_d", 10], "DashedAcceptabilityJudgment", {s: "Konuşmacının sunucusu olağanüstü bir hızla koştu."  } ],
[["condition_a", 11], "DashedAcceptabilityJudgment", {s: "Psikiyatristlerin eczacısı aç susuz çalıştılar."  } ],
[["condition_b", 11], "DashedAcceptabilityJudgment", {s: "Psikiyatristlerin eczacısı aç susuz çalıştı."  } ],
[["condition_c", 11], "DashedAcceptabilityJudgment", {s: "Psikiyatristin eczacısı aç susuz çalıştılar."  } ],
[["condition_d", 11], "DashedAcceptabilityJudgment", {s: "Psikiyatristin eczacısı aç susuz çalıştı."  } ],
...
[["condition_a", 16], "DashedAcceptabilityJudgment", {s: "Milyonerlerin terzisi tamamen gereksizce kovuldular."  } ],
[["condition_b", 16], "DashedAcceptabilityJudgment", {s: "Milyonerlerin terzisi tamamen gereksizce kovuldu."  } ],
[["condition_c", 16], "DashedAcceptabilityJudgment", {s: "Milyonerin terzisi tamamen gereksizce kovuldular."  } ],
[["condition_d", 16], "DashedAcceptabilityJudgment", {s: "Milyonerin terzisi tamamen gereksizce kovuldu."  } ],
...
[["condition_a", 19], "DashedAcceptabilityJudgment", {s: "Futbolcuların sürücüsü çok yavaş ilerlediler."  } ],
[["condition_b", 19], "DashedAcceptabilityJudgment", {s: "Futbolcuların sürücüsü çok yavaş ilerledi."  } ],
[["condition_c", 19], "DashedAcceptabilityJudgment", {s: "Futbolcunun sürücüsü çok yavaş ilerlediler."  } ],
[["condition_d", 19], "DashedAcceptabilityJudgment", {s: "Futbolcunun sürücüsü çok yavaş ilerledi."  } ],
...
[["condition_a", 27], "DashedAcceptabilityJudgment", {s: "Dalgıçların eğitimcisi bile bile geç kaldılar."  } ],
[["condition_b", 27], "DashedAcceptabilityJudgment", {s: "Dalgıçların eğitimcisi bile bile geç kaldı."  } ],
[["condition_c", 27], "DashedAcceptabilityJudgment", {s: "Dalgıcın eğitimcisi bile bile geç kaldılar."  } ],
[["condition_d", 27], "DashedAcceptabilityJudgment", {s: "Dalgıcın eğitimcisi bile bile geç kaldı."  } ],
